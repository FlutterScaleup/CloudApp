...
print('now:$now');
    ...
    // if(selectedStatusValue == "In Progress"){
    //   if(workDoneEditingController.text.isEmpty){
    //     Fluttertoast.showToast(msg: "Write work done");
    //     return;
    //   } else if(workPendingEditingController.text.isEmpty){
    //     return;
    //   }
    // }
    print('iprogress:${selectedTaskValue}');
    if (selectedTaskValue == "Core task") {
      ...
      if (selectedStatusValue == "In Progress") {
        ...
        if (workDoneEditingController.text.isEmpty) {
          ...
          Fluttertoast.showToast(
              msg:
              "Write Work Pending description");
          return;
        } else {
          textEditingController.text = '';
          textEditingController.text = 'Work Done: ' +
              workDoneEditingController.text +
              "\nWork Pending: " +
              workPendingEditingController.text;
        }
      ...
      // }
      //
      // print('checckkkk:${workPendingEditingController.text.isEmpty}');
              ...
              ListView.builder(
                ...
                itemBuilder: (itemBuilder, index) {
                  ...
                  Future.delayed(const Duration(seconds: 1), () {
                    totalHours.value =
                    "Total Hours: ${list.map((e) => double.parse(e['hour']))
    ...
    if (selectedMemberValue == "Member Name") {
      ...
      if (sharedPreference.get("email") != null &&
        ...
        if (emailList!.contains(sharedPreference.get("email"))) {
          ...
          var itemsMember = (await sheet.values.columnByKey(
              "Team Member Name"))!;
          selectedMemberValue = itemsMember![index];
          sharedPreference.setString("member", selectedMemberValue);
        }
        print("Memberrrr2 $selectedMemberValue");
        // list.add({
        //   "date": now,
        //   "member": selectedMemberValue,
        //   "project": "No Project",
