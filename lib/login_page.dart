...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    ...
    // myController.textEditingControllerEmail.text="sapna.jain@scaleupally.io";
    // textEditingControllerPass.text="Sapna@123";
  }
...
if(myController.isOptionSelected.value==false){
  Fluttertoast.showToast(msg: "Please select option");
    ...
    sharedPreference.setString(
        "email", myController.textEditingControllerEmail.text.toLowerCase());
