...
class _LeavePageState extends State<LeavePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: const Text("Leave",style: TextStyle(fontWeight: FontWeight.bold),),
    actions: [Material(borderRadius: BorderRadius.circular(8),elevation: 2,
      ...
      },child: Container(decoration: BoxDecoration(color: Colors.grey[100],borderRadius: BorderRadius.circular(8)),padding: const EdgeInsets.only(top: 4,bottom: 4,left: 16,right: 16),child: const Text("Logs",style: TextStyle(fontWeight: FontWeight.bold),))),
      ...
      children: [
        Expanded(
          child: Material(elevation: 0,borderRadius: BorderRadius.circular(16),
            child: Container(margin: const EdgeInsets.only(bottom: 16),padding: const EdgeInsets.all(16),decoration: BoxDecoration(color: boxColor,borderRadius: BorderRadius.circular(16)),child:
            Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
              ...
              },child: Material(elevation: 2,borderRadius: BorderRadius.circular(16),child: Container(padding: const EdgeInsets.only(top: 8,bottom: 8,left: 16,right: 16),decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(16)),child: Text("Apply leave",style: TextStyle(color: headerTextColor,fontWeight: FontWeight.bold)),)))
